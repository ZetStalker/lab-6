...
def predict(sl,sw,pl,pw):
    ...
    response_html=str(f"""<!DOCTYPE html>
        <html lang="ru">
                ...
                <body>
                    <p>Длина наружной доли ококлоцветника:{sl} </p>
                    <p>Ширина наружной доли ококлоцветника:{sw}  </p>
                    <p>Длина внутренней доли ококлоцветника:{pl} </p>
                    <p>Ширина внутренней доли ококлоцветника:{pw} </p>
                    <p>Предполагаемый класс: {iris.target_names[predicted_class][0]}</p>
                    <p><a href= "../" >Назад</a></p>
                </body>
        </html>""")
